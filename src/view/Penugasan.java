 ...
 * @author fauza
 */
public final class Penugasan extends javax.swing.JFrame {
    int xx, xy;
    /**
    ...
    private void initComponents() {
        ...
        getContentPane().add(deskripsiName, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 250, -1, 30));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Penugasan penugasanForm = new Penugasan();
                penugasanForm.setVisible(true);
                penugasanForm.pack();
                penugasanForm.setLocationRelativeTo(null);
                penugasanForm.setDefaultCloseOperation(Penugasan.EXIT_ON_CLOSE);
            }
        });
    }
